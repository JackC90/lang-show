...
class SentencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sentence" do
    assert_difference('Sentence.count') do
      post sentences_url, params: { sentence: { note: @sentence.note, reference: @sentence.reference, source_url: @sentence.source_url, text: @sentence.text } }
    end
  ...
  test "should update sentence" do
    patch sentence_url(@sentence), params: { sentence: { note: @sentence.note, reference: @sentence.reference, source_url: @sentence.source_url, text: @sentence.text } }
